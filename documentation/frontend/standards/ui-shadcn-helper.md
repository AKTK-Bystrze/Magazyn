...
This project uses the "new-york" style variant with the "neutral" base color and CSS variables for theming, according to the configuration in the `components.json` file.
