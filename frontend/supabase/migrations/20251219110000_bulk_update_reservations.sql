-- Migration: Add Bulk Update Reservations Status RPC
-- Description: Updates multiple reservations and handles credit refunds if status is changed to DENIED.
...
BEGIN
    ...
    LOOP
        ...
        IF p_status = 'DENIED' THEN
            ...
            -- We should find the matching 'reservation_charge' in credit_history
            -- or calculate it from equipment_type cost at the time (simplified here)
            ...
            IF v_refund_amount > 0 THEN
                ...
                INSERT INTO credit_history (user_id, amount, reason, description, reservation_id, admin_id)
